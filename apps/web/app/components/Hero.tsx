    ...
    <>
      <div className="bg-gradient-to-r from-[#0F172A] via-[#2b145a]  to-gray-800 w-full h-screen flex flex-col justify-center items-center text-white">
        ...
        <div className="flex space-x-4">
          <button
            className="bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-4 rounded-full shadow-md transition duration-300"
            onClick={() => {
              router.push("/chat");
            }}
          >
          ...
          <button className="border border-white hover:bg-white hover:text-blue-600 text-white font-semibold py-2 px-4 rounded-full shadow-md transition duration-300">
            Learn More
          </button>
        </div>
      </div>
