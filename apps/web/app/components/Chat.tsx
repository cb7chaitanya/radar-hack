  ...
  <h1 className="text-left ml-8 mt-4 text-2xl font-bold">Bodhi</h1>
        ...
        <div className="mt-10 w-full max-w-4xl mx-auto flex flex-col items-center justify-center h-full py-10 space-y-8">
          ...
          <h1 className="text-center font-bold text-4xl sm:text-5xl lg:text-6xl">
            Hi there, <span className="text-[#a855f7]">John</span> <br /> What <span className="text-[#38bdf8]">would like to know</span>?
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gray-800 rounded-lg p-4 text-center">
              <p className="text-lg text-white">I want some tokens,can you assist me with that</p>
            </div>
            <div className="bg-gray-800 rounded-lg p-4 text-center">
              <p className="text-lg text-white">Generate tokens worth $1000 USDC</p>
            </div>
            <div className="bg-gray-800 rounded-lg p-4 text-center">
              <p className="text-lg text-white">I have solana can i exchange it with your tokens?</p>
            </div>
            <div className="bg-gray-800 rounded-lg p-4 text-center">
              <p className="text-lg text-white">How much do i need to pay to get 1 token?</p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg w-full p-4 flex items-center space-x-3">
            ...
            />
            <button className="bg-[#38bdf8] p-3 rounded-full">
            <ArrowUp />
            </button>
          </div>
